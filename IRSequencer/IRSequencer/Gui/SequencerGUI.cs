...
namespace IRSequencer_v3.Gui
{
    ...
    public class SequencerGUI : MonoBehaviour
    {
        ...
        {
            Logger.Log(string.Format("[IRS]: Trying to display this shitty button"));
            ...
            try
            {
                Logger.Log(string.Format("[IRS]Hello before trying to find the icon"));
                Texture2D texture = UIAssetsLoader.iconAssets.Find(i => i.name == "icon_seq_button");
                Logger.Log(string.Format("[IRS]bug after the icon has been loaded"));
        ...
        private void InitSequenceLinePrefab(GameObject sequenceLinePrefab, Sequence s, ModuleSequencer_v3 module)
        {
            ...
            var template = endStateDropdown.transform.Find("Template");
